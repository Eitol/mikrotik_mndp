...
void main() {
  test('adds one to input values', () async {
    String data = '\x00\x00\x00\x07\x00\x01\x00\x06H\x8fZ\xad~\xe9\x00\x05\x00\x08MikroTik\x00\x07\x00\x126.45.9 ('
    ...
    var productInfoProvider =        MikrotikProductInfoProvider();
